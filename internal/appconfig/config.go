...
type Config struct {
	...
	KillSignal     *string       `toml:"kill_signal,omitempty" json:"kill_signal,omitempty" enum:"SIGINT,SIGTERM,SIGQUIT,SIGUSR1,SIGUSR2,SIGKILL,SIGSTOP"`
...
type Deploy struct {
	...
	Strategy              string        `toml:"strategy,omitempty" json:"strategy,omitempty" enum:"canary,rolling,bluegreen,immediate"`
